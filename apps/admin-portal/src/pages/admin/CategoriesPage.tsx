            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  {/* Parent Category - shown when editing or when explicitly adding subcategory */}
                  {(editingCategory || showSubcategoryModal) && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Parent Category {showSubcategoryModal && '*'}
                      </label>
                      <select
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {formData.parentId ? 'This is a subcategory' : 'This is a main category'}
                      </p>
                    </div>
                  )}
